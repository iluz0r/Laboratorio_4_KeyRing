...
public class RunGenPKR {
	...
	public static void main(String[] args) {
		...
		try {
			...
			pkr.setKey("Ancora_EPK", publicKey);
			...
			pkr.setKey("Ancora_SPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("Linneo_EPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("Linneo_SPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("Doriana_EPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("Doriana_SPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("IPini_EPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("IPini_SPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("MakeNao_EPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("MakeNao_SPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("LupiLupi_EPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("LupiLupi_SPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("GalloSalvato_EPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("GalloSalvato_SPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("FrankAbba_EPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("FrankAbba_SPK", publicKey);
			...
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("GAS_SPK", publicKey);

			// Gruppo RDF
			keyFactory = KeyFactory.getInstance("RSA");
			encodedKey = Base64.getDecoder().decode(
					"MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCE+XJNEVJeOqqY5BZHjcEKZ/AKfq99QsawZ9teCE6yBkKeDNbnOE9ks520aIre1HNHiq6GR+Qv2mrBWMqvxBbmzB5+Fp1JFVCG5bMXFBBZ0vg76CW9qGZYB6wtbWcUryXl7YNMw8qFhqATg4/OnaN5I3c5Dp4WIqvzskAnb5HWhwIDAQAB");
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("RDF_EPK", publicKey);

			keyFactory = KeyFactory.getInstance("DSA");
			encodedKey = Base64.getDecoder().decode(
					"");
			publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			pkr.setKey("RDF_SPK", publicKey);
